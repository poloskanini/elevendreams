...
export default function Contact() {
  return (
    ...
    <div className={styles.contactWrapper}>
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 mt-10">
          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl className="mt-10 space-y-4 text-base/7 text-gray-300">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="tel:+33688068413" className="hover:text-white">
                    0688068413
                  </a>
                </dd>
              </div>
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="block w-full rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-slate-300 sm:text-sm/6"
                  />
                </div>
              </div>
              <div>
